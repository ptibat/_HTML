...
var _js = {
					...
					if( window.addEventListener )
					  {
						...
						window.addEventListener("keydown", function(e){
							...
							_js.konami_keys += ( _js.konami_keys.length > 0 ? "," : "" ) + e.keyCode;

							var regex	= new RegExp( "^" + _js.konami_keys + "" , "g" );

							if( _js.konami_code.match( regex ) )
								  {
									e.preventDefault();

							  	if( _js.konami_keys == _js.konami_code )
								  {
									_js.konami_keys = "";
									_js.konami_func();
								  }
	...
	*/
	...
	init_touch_hover : function ( selector , klass )
				   {
					...
					$(selector).on("touchstart touchend", function(e) {
	...
	*/
	...
	getUrlParameter : function( sParam , url )
				   {
					var	sPageURL 		= ( ( typeof(url)!="undefined" ) ? url : decodeURIComponent(window.location.search.substring(1)) ),
	...
	*/
	...
	speak : function ( text , lang )
				{
					lang = ( lang != undefined ? lang : "fr-FR" );
	...
	*/
	...
	/**
	* ACTIVATION OU DESACTIVATION DU SCROLL
	...
	*/
	...
	/**
	* TAILLE DE LA FENETRE DU NAVIGATEUR OU DU DOCUMENT
	* src : https://stackoverflow.com/questions/14184447/firefox-extension-to-show-current-window-dimensions
	*/

	window_size : function()
				{
					var id = 'measurements'; // abstracted-out for convenience in renaming
	...
	get_window_size : function()
				{
					return $(window).width() + "px x " + $(window).height() + "px";
				},

	get_document_size : function( full )
				{
					return $(document).width() + "px x " + $(document).height() + "px";
				},
	...
	*/
	...
	/**
	* DETECTION DES SESSION DE NAVIGATION PRIVÉE
	* src : https://stackoverflow.com/questions/2860879/detecting-if-a-browser-is-using-private-browsing-mode/37091058#37091058
	*/

	is_private_mode : function()
				{
...
var _HTML_BODY = ( _js.is_mobile() ? "body" : "html" );
